  ...
  const fieldViews = (
    <Stack>
      <Stack.Item key='image' align='stretch'>
        <CardImageField card={card} editing={editing} />
      </Stack.Item>
      {mFields.map((field) => (
        <Stack.Item key={field.key} align='stretch'>
          <CardMandatoryField field={field} editing={editing} onEdit={field.onEdit} />
        </Stack.Item>
      ))}
      <Stack.Item key='note' align='stretch'>
        <CardNoteField field={note} editing={editing} />
      </Stack.Item>
      {restFields.map((field) => (
        <Stack.Item key={field.key} align='stretch'>
          <CardExtraField field={field} editing={editing} />
        </Stack.Item>
      ))}
    </Stack>
  );
